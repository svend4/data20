...
### ⚡ САМЫЙ ПРОСТОЙ СПОСОБ (5 секунд)

```bash
./create-release.sh
```

**Готово!** APK соберется автоматически через 20 минут. 

👉 **Подробно: [SIMPLE_RELEASE.md](SIMPLE_RELEASE.md)**
...
├─────────────────────────────────────────────────────────────┤
│                                                               │
│  ⚡ АВТОМАТИЧЕСКИ (БЫСТРО)    ⏱️  5 сек     💰 Бесплатно    │
│     └─ ./create-release.sh → SIMPLE_RELEASE.md               │
│                                                               │
...
|----------|----------|-------------------|
| **[SIMPLE_RELEASE.md](SIMPLE_RELEASE.md)** | ⚡ **САМЫЙ ПРОСТОЙ СПОСОБ** - Одна команда для релиза | Начните здесь! |
