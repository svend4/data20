...
MOCK_TOOLS = [
    ...
    {
        "name": "regex_matcher",
        "display_name": "Поиск по regex",
        "description": "Поиск совпадений по регулярному выражению",
        "category": "text",
        "parameters": {
            "text": {"type": "string", "required": True, "description": "Текст для поиска"},
            "pattern": {"type": "string", "required": True, "description": "Регулярное выражение"}
        }
    },
    {
        "name": "regex_replacer",
        "display_name": "Замена по regex",
        "description": "Замена текста по регулярному выражению",
        "category": "text",
        "parameters": {
            "text": {"type": "string", "required": True, "description": "Исходный текст"},
            "pattern": {"type": "string", "required": True, "description": "Регулярное выражение"},
            "replacement": {"type": "string", "required": True, "description": "Текст замены"}
        }
    },
    {
        "name": "fibonacci_generator",
        "display_name": "Числа Фибоначчи",
        "description": "Генерация последовательности Фибоначчи",
        "category": "math",
        "parameters": {
            "count": {"type": "integer", "required": False, "default": 10, "description": "Количество чисел"}
        }
    },
    {
        "name": "prime_checker",
        "display_name": "Проверка простых чисел",
        "description": "Проверка является ли число простым",
        "category": "math",
        "parameters": {
            "number": {"type": "integer", "required": True, "description": "Число для проверки"}
        }
    },
    {
        "name": "factorial_calculator",
        "display_name": "Факториал",
        "description": "Вычисление факториала числа",
        "category": "math",
        "parameters": {
            "number": {"type": "integer", "required": True, "description": "Число"}
        }
    },
    {
        "name": "gcd_lcm_calculator",
        "display_name": "НОД и НОК",
        "description": "Вычисление НОД (наибольший общий делитель) и НОК (наименьшее общее кратное)",
        "category": "math",
        "parameters": {
            "a": {"type": "integer", "required": True, "description": "Первое число"},
            "b": {"type": "integer", "required": True, "description": "Второе число"}
        }
    },
    {
        "name": "binary_search",
        "display_name": "Бинарный поиск",
        "description": "Поиск элемента в отсортированном массиве",
        "category": "cleaning",
        "parameters": {
            "data": {"type": "array", "required": True, "description": "Отсортированный массив"},
            "target": {"type": "number", "required": True, "description": "Искомое значение"}
        }
    },
    {
        "name": "palindrome_checker",
        "display_name": "Проверка палиндрома",
        "description": "Проверка является ли строка палиндромом",
        "category": "text",
        "parameters": {
            "text": {"type": "string", "required": True, "description": "Текст для проверки"},
            "ignore_spaces": {"type": "boolean", "required": False, "default": True, "description": "Игнорировать пробелы"}
        }
    },
    {
        "name": "anagram_checker",
        "display_name": "Проверка анаграмм",
        "description": "Проверка являются ли строки анаграммами",
        "category": "text",
        "parameters": {
            "text1": {"type": "string", "required": True, "description": "Первая строка"},
            "text2": {"type": "string", "required": True, "description": "Вторая строка"}
        }
    },
    {
        "name": "text_encoder",
        "display_name": "Кодирование текста",
        "description": "Кодирование текста (ROT13, Atbash)",
        "category": "transformation",
        "parameters": {
            "text": {"type": "string", "required": True, "description": "Текст"},
            "method": {"type": "string", "required": True, "enum": ["rot13", "atbash"], "description": "Метод кодирования"}
        }
    },
    {
        "name": "credit_card_validator",
        "display_name": "Валидатор карт",
        "description": "Проверка номера карты алгоритмом Луна",
        "category": "other",
        "parameters": {
            "card_number": {"type": "string", "required": True, "description": "Номер карты"}
        }
    },
    {
        "name": "email_validator",
        "display_name": "Валидатор email",
        "description": "Проверка валидности email адреса",
        "category": "other",
        "parameters": {
            "email": {"type": "string", "required": True, "description": "Email адрес"}
        }
    },
    {
        "name": "phone_formatter",
        "display_name": "Форматирование телефонов",
        "description": "Форматирование телефонных номеров",
        "category": "other",
        "parameters": {
            "phone": {"type": "string", "required": True, "description": "Номер телефона"},
            "format": {"type": "string", "required": False, "default": "international", "enum": ["international", "national"], "description": "Формат"}
        }
    },
    {
        "name": "slug_generator",
        "display_name": "Генератор slug",
        "description": "Генерация URL-совместимого slug из текста",
        "category": "text",
        "parameters": {
            "text": {"type": "string", "required": True, "description": "Текст для slug"}
        }
    },
    {
        "name": "html_entities",
        "display_name": "HTML entities",
        "description": "Кодирование/декодирование HTML entities",
        "category": "transformation",
        "parameters": {
            "text": {"type": "string", "required": True, "description": "Текст"},
            "operation": {"type": "string", "required": True, "enum": ["encode", "decode"], "description": "Операция"}
        }
    },
    {
        "name": "levenshtein_distance",
        "display_name": "Расстояние Левенштейна",
        "description": "Вычисление расстояния редактирования между строками",
        "category": "text",
        "parameters": {
            "text1": {"type": "string", "required": True, "description": "Первая строка"},
            "text2": {"type": "string", "required": True, "description": "Вторая строка"}
    ...
    },
    {
        ...
        "display_name": "Статистика сжатия",
        "description": "Анализ потенциала сжатия данных",
        "category": "other",
        "parameters": {
            "data": {"type": "string", "required": True, "description": "Данные для анализа"}
        }
    },
    {
        "name": "dice_roller",
        "display_name": "Бросок кубиков",
        "description": "Симуляция броска игральных кубиков",
        "category": "math",
        "parameters": {
            "dice": {"type": "string", "required": False, "default": "1d6", "description": "Формат: NdM (например, 2d6)"}
        }
    },
    {
        "name": "coin_flipper",
        "display_name": "Подбрасывание монеты",
        "description": "Симуляция подбрасывания монеты",
        "category": "math",
        "parameters": {
            "count": {"type": "integer", "required": False, "default": 1, "description": "Количество бросков"}
        }
    },
    {
        "name": "hamming_distance",
        "display_name": "Расстояние Хэмминга",
        "description": "Вычисление расстояния Хэмминга между строками",
        "category": "text",
        "parameters": {
            "text1": {"type": "string", "required": True, "description": "Первая строка"},
            "text2": {"type": "string", "required": True, "description": "Вторая строка"}
    ...
    },
    {
        ...
        "display_name": "Калькулятор окружности",
        "description": "Вычисление параметров окружности (площадь, длина)",
        "category": "math",
        "parameters": {
            "radius": {"type": "number", "required": True, "description": "Радиус"}
        }
    },
    {
        "name": "triangle_calculator",
        "display_name": "Калькулятор треугольника",
        "description": "Вычисление параметров треугольника (площадь, периметр)",
        "category": "math",
        "parameters": {
            "a": {"type": "number", "required": True, "description": "Сторона A"},
            "b": {"type": "number", "required": True, "description": "Сторона B"},
            "c": {"type": "number", "required": True, "description": "Сторона C"}
        }
    }
]
