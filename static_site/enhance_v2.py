#!/usr/bin/env python3
"""
Enhanced Site Generator v2 - Phase 2: Enhanced Features
Включает все улучшения из v1 PLUS:
- Data Explorer: Интерактивный просмотр JSON/CSV с множеством view modes
- Interactive Dashboard: Живая аналитика с графиками (Chart.js)
- Graph Viewer: Визуализация связей между файлами (vis-network)
- Улучшенные карточки с кнопкой "View Data"
- Полностью интерактивный опыт
"""
...
<head>
    ...
    <title>Knowledge Base - Enhanced Dashboard v2.0</title>
...
"""
                ...
                # Добавить кнопку View Data для JSON/CSV
                if file.suffix in ['.json', '.csv']:
                    html += f"""
                        <button class="btn btn-primary" onclick="dataExplorer.open('{metadata['path']}')">
                            🔍 View Data
                        </button>
"""
                else:
...
"""
    ...
    <footer class="page-footer">
        <p>🚀 Generated by Enhanced Knowledge Base Static Site Generator v2.0</p>
        <p>55 инструментов | 25+ алгоритмов | Interactive Features | Production Ready</p>
    </footer>

    <!-- Phase 1 Scripts -->
    <script src="assets/js/enhanced.js"></script>

    <!-- Phase 2 Scripts (Order matters!) -->
...
"""
    ...
    def generate(self):
        ...
        print("Улучшения v2.0 (Phase 1 + Phase 2):")
        print("  Phase 1:")
        ...
        print("\n  Phase 2 (НОВОЕ):")
        print("    ✓ Data Explorer (интерактивный просмотр JSON/CSV)")
        print("    ✓ Interactive Dashboard (живая аналитика)")
        print("    ✓ Graph Viewer (визуализация связей)")
        print("    ✓ Кнопка 'View Data' на JSON/CSV файлах\n")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Enhanced Site Generator v2.0 для Knowledge Base - Phase 2',
...
Улучшения v2.0 (Enhanced Features):
  Phase 1 (Quick Wins):
  ...
  Phase 2 (Enhanced Features) - НОВОЕ:
    - Data Explorer: Интерактивный просмотр JSON/CSV данных
      (Tree View, Table View, Raw View, Chart View, Statistics)
    - Interactive Dashboard: Живая аналитика с графиками
      (Activity charts, Category distribution, Quality score)
    - Graph Viewer: Визуализация связей между файлами
      (Force-directed, Hierarchical, Circular layouts)
    - Кнопка "View Data" на JSON/CSV карточках
        """
    )
