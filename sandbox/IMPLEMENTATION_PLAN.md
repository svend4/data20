...
### Этап 2: Темы (Light/Dark) (Приоритет: 🟡 Medium)

**Цель**: Добавить переключение между светлой и тёмной темами

**Шаги**:
1. ⏳ Создать CSS variables для цветов
2. ⏳ Создать theme-manager.js
3. ⏳ Добавить кнопку переключения темы
4. ⏳ Сохранять выбор в chrome.storage.local
5. ⏳ Применять тему при загрузке
6. ⏳ Добавить анимацию перехода
7. ⏳ Тестировать в разных вкладках
...
### Этап 4: Desktop Notifications (Приоритет: 🟢 Low)

**Цель**: Улучшенные уведомления с действиями

**Шаги**:
1. ⏳ Создать notification-manager.js
2. ⏳ Добавить rich notifications
3. ⏳ Добавить action buttons
4. ⏳ Добавить progress notifications
5. ⏳ Добавить звуковые уведомления (опционально)
6. ⏳ Настройки уведомлений
7. ⏳ Тестировать на разных ОС
8. ⏳ Документировать в EXPERIMENTS.md
